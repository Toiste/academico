...
public class Entrada {
    ...
    public Entrada() {
        try {
            ...
            this.input = new Scanner(new FileInputStream("academico/input.txt"));
    ...
    private String lerLinha(String msg){
        ...
        try{
            ...
            System.out.println("Erro: Não é permitido valores vazios.");
            System.exit(0);
        }
        return linha;
    }
    ...
    private int lerInteiro(String msg){
        ...
        try{
            ...
            numInteiro = Integer.parseInt(linha);
        }catch (IllegalArgumentException | StringIndexOutOfBoundsException e){
            System.out.println("Erro: formato incorreto. Digite apenas um Numero inteiro.");
            System.exit(0);
        }
        return  numInteiro;
    }
    ...
    private double lerDouble(String msg) {
        ...
        try{
            String linha = this.lerLinha(msg);
            numDouble = Double.parseDouble(linha);
        }catch (IllegalArgumentException | StringIndexOutOfBoundsException e){
            System.out.println("Erro: formato incorreto. Digite apenas um Numero Double.");
            System.exit(0);
        }
        return  numDouble;
    }
    ...
    public void cadProf(Sistema s) {
        ...
        try {
            ...
            System.out.println("Erro: Entrada inválida. Professor não foi cadastrado.");
            System.exit(0);
        }
    }
    ...
    public void cadAluno(Sistema s) {
        ...
        try {
            ...
            System.out.println("Erro: Entrada inválida. Aluno não foi cadastrado.");
            System.exit(0);
        }
     ...
     */
    private Professor lerProf(Sistema s) throws StringIndexOutOfBoundsException{
        s.listarProfs();
    ...
    private Avaliacao[] lerAvaliacoes(Sistema s, Aluno[] alunos) {
        int nAvaliacoes;
        try{
            nAvaliacoes = this.lerInteiro("Digite a quantidade de avaliações na disciplina: ");
        } catch (IllegalArgumentException | StringIndexOutOfBoundsException e) {
    ...
    public Turma cadTurma(Sistema s) {
        try {
            ...
            System.out.println("Erro: Entrada inválida. Turma não foi cadastrada.");
            System.exit(0);
        }
