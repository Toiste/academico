...
public class Entrada {
    ...
    public Entrada() {
        try {
            ...
            this.input = new Scanner(new FileInputStream("academico/iput.txt"));
    ...
    private int lerInteiro(String msg){
        ...
        while(sinaliza != 0){
            try{
                ...
                System.out.println("Erro: formato incorreto. Digite apenas um Numero inteiro. Tente novamente.");
            }
    ...
    private double lerDouble(String msg) {
        ...
        while(sinaliza != 0){
            try{
                ...
                System.out.println("Erro: formato incorreto. Digite apenas um Numero Double. Tente novamente.");
            }
